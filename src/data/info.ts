export const info = {
  ...
  about: {
    description: `I'm a full stack developer with a passion for causing a little chaos in web and backend development.
    I have a solid foundation in Information Systems, although I prefer playing drums over studying.
    I excel in my applications using the technologies .NET, Node.JS, SQL Server, TypeScript
